...
const Contact = () => {
	...
	const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
		...
		window.location.href = `mailto:oddsworld0121@gmail.com?subject=Message from ${name}&body=Name: ${name}%0AEmail: ${email}%0AMessage: ${message}`;
				...
				<div className="flex flex-col lg:flex-row justify-between items-start gap-12 pt-8">
					...
					<div className="flex flex-col justify-between items-start gap-8">
						...
						<div className="flex flex-col justify-between items-start gap-5">
							...
							<Link href="mailto:oddsworld0121@gmail.com" >
								<Button variant="ghost" className="text-gray-500">
									<LucideMail className="mr-4" /> oddsworld0121@gmail.com
								</Button>
							</Link>
							<Button variant="ghost" className="text-gray-500">
								<PhoneIcon className="mr-4" /> +91 952 184 4332
							</Button>
						</div>
